...
# Updated by Anushka Vidanage, Jul 2021
#
# Usage:
#
#  python3 generate-student-dataset2.py [anu_id] [master_data_set_name]
#
# -----------------------------------------------------------------------------
...
student_data_set_name = 'data_wrangling_education_2021_%s.csv' % (anu_id)
...
print('-'*40)
print()
print('Your student data set for the second data wrangling 2021 assignment')
